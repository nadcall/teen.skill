      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto items-center">
          <SignUpButton mode="modal">
            <Button className="w-full sm:w-auto px-10 py-4 text-lg shadow-xl shadow-sky-500/20 transform hover:scale-105 transition-transform">
              Daftar Baru <ArrowRight className="w-5 h-5 ml-1" />
            </Button>
          </SignUpButton>
          <SignInButton mode="modal">
            <Button variant="secondary" className="w-full sm:w-auto px-10 py-4 text-lg border-2 border-white/50">
              <UserCheck className="w-5 h-5 mr-2" /> Masuk
            </Button>
          </SignInButton>
        </div>
